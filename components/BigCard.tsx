...
export const BigCard = (props: Props) => {
  return (
    <div className='p-6 pt-[100px] max-w-[500px] m-4 rounded rounded-tr-2xl rounded-bl-2xl relative bg-primary/80 h-fit w-fit'>
        ...
        <button className='shadow-lg w-fit border-2 border-white px-6 py-2 mt-6 rounded-2xl bg-secondary hover:bg-secondaryLighter text-white font-medium'>See more</button>
        </div>
    </div>
  )
}